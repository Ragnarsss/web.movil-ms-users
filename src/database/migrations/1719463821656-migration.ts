...
export class Migration1719463821656 implements MigrationInterface {
    name = 'Migration1719463821656'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "time_card_entries" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL, "morning_start" TIMESTAMP, "morning_end" TIMESTAMP, "afternoon_start" TIMESTAMP, "afternoon_end" TIMESTAMP, "overtime_start" TIMESTAMP, "overtime_end" TIMESTAMP, "total_hours" integer, "time_card_id" uuid, CONSTRAINT "PK_0c6f38c61a55010ea77f200a1fc" PRIMARY KEY ("id"))`);
